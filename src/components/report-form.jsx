...
import { IN_PICTURE_TYPES } from "@/lib/data"
import { IconCheck, IconClose, IconLock, IconSend } from "./icons"
...
export function ReportForm({ open, onClose, onSubmitted }) {
  ...
  const [form, setForm] = useState({ inPicture: "", platform: "", contacted: "", askedFor: "", consent: false })
