export function IconShield({ check = false, ...props }) {
  return (
    <svg className={props.className ? `icon ${props.className}` : "icon"} viewBox="0 0 24 24" aria-hidden="true" {...props}>
...
export function IconWarning(props) {
  return (
    <svg className={props.className ? `icon ${props.className}` : "icon"} viewBox="0 0 24 24" {...props}>
...
export function IconFacebook(props) {
  return (
    <svg className={props.className ? `icon icon--brand ${props.className}` : "icon icon--brand"} viewBox="0 0 24 24" aria-hidden="true" {...props}>
...
export function IconHeart({ filled = false, ...props }) {
  return (
    <svg className={props.className ? `icon ${props.className}` : "icon"} viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke={filled ? "none" : "currentColor"} strokeWidth="2" aria-hidden="true" {...props}>
      <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
    </svg>
  )
}

export function IconSave({ filled = false, ...props }) {
  return (
    <svg className={props.className ? `icon ${props.className}` : "icon"} viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke={filled ? "none" : "currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
...
export function IconMapPin(props) {
  return (
    <svg className={props.className ? `icon ${props.className}` : "icon"} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true" {...props}>
...
export function IconUsers(props) {
  return (
    <svg className="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
